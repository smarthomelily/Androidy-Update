...
4. "Anderes Symbol" → `Androidy-Update.ico` auswählen
...
| `Androidy-Update-Verknuepfung.bat` | Erstellt Desktop-Verknüpfung |
| `Androidy-Update-Verknuepfung.ps1` | PowerShell-Skript für Verknüpfung |
| `Androidy-Update.ico` | Icon für Verknüpfungen |
